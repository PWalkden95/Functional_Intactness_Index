...
hist(TPD_data$S2logHPD)

hist(TPD_data$S2RD50K)
hist(sqrt(TPD_data$S2RD50K))

hist(TPD_data$S2RD1K)
hist(TPD_data$S2RD1K^(1/2))

hist(TPD_data$env_distance)
hist(TPD_data$env_distance^(1/3))
...
Model_12 <- lmer(formula = logitOver ~ Cont + logdist + rt3env + sqrtS2RD1K + 
